       ...
       // Debug.Log(currentEvent.mousePosition);
        ...
        switch (nodeRequested)
        {
            ...
            default:
                ...
                break;
                //case "xRotation":
                //    windows.Add(new ControllerNode(new Rect(mousePos.x, mousePos.y, 100, 100), "NoiseRing", "xRotation"));
                //    break;
                //case "yScale":
                //    windows.Add(new ControllerNode(new Rect(mousePos.x, mousePos.y, 100, 100), "NoiseRing", "yScale"));
                //    break;
        }
    }
